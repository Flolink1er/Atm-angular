...
@Component({
  ...
  imports: [MatFormFieldModule, MatInputModule, MatTableModule, MatSortModule, MatPaginatorModule, MatAnchor, MatIconModule],
  templateUrl: './landing-list.html',
  styleUrl: './landing-list.scss',
})
export class LandingList {
  displayedColumns: string[] = ['clients', 'cards'];
